...
public class ButtonSetting : MonoBehaviour
{
    ...
    public void OnPointerOn() {
        ...
        if(text!=null) text.color = button.colors.normalColor;//blue
    ...
    {
        if (!button.interactable) return;
        if (text != null) text.color = button.colors.selectedColor;
        
        if (isSelected) { if (text != null) text.color = button.colors.normalColor; }
    }
